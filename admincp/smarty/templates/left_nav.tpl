    ...
    <li class="user-details cyan darken-2">
      <div class="row">
        <div class="col col s4 m4 l4"> 
          <img src="{#url#}images/{if $smarty.session.gender==1}avatar_boy1{else}avatar_girl1{/if}.jpg" alt="avatar" class="circle responsive-img valign profile-image"> 
        </div>
        <div class="col col s8 m8 l8">
          <ul id="profile-dropdown" class="dropdown-content">
            <li><a href="profile.php?id_user={$smarty.session.id_user}">
            ...
            <li><a href=".?logout={$smarty.session.username}"><i class="mdi-hardware-keyboard-tab"></i> Logout</a> </li>
          </ul>
          <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">{$smarty.session.fullname}</a>
          <p class="user-roal">{$smarty.session.role}</p>
        </div>
      </div>
    </li>
