	...
	public function showPagination(){
		...
		if($this->_totalPage > 1){
			...
			if($this->_currentPage > 1){
				...
				$prev 	= '<li class="waves-effect">
								<a href="?page='.($this->_currentPage-1).'">
			...
			if($this->_currentPage < $this->_totalPage){
				...
				$end 	= '<li class="waves-effect"><a href="?page='.$this->_totalPage.'">End</a></li>';
			}
			...
			for($i = $startPage; $i <= $endPage; $i++){
				if($i == $this->_currentPage) {
					$listPages .= '<li class="active"><a>'.$i.'</a>';
				}else{
					$listPages .= '<li class="waves-effect"><a href="?page='.$i.'">'.$i.'</a>';
				}
			}
